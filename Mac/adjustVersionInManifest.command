...
if [ "$PROJECT_VERSION" != "" ]; then
	...
	#
	sed -E "s/(<Extension +Id=\"[^\"]*\" +Version=\")([0-9\.]*)(\")/\1$PROJECT_VERSION\3/" < CSXS/manifest.xml | sed -E "s/(ExtensionBundleVersion=\")([0-9\.]*)(\")/\1$PROJECT_VERSION\3/" < CSXS/manifest.xml > CSXS/manifest.xml.new
