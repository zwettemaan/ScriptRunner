...
REG add HKEY_CURRENT_USER\Software\Adobe\CSXS.9 /v LogLevel /t REG_SZ /d 5 /f > NUL
REG add HKEY_CURRENT_USER\Software\Adobe\CSXS.10 /v PlayerDebugMode /t REG_SZ /d 1 /f > NUL
REG add HKEY_CURRENT_USER\Software\Adobe\CSXS.10 /v LogLevel /t REG_SZ /d 5 /f > NUL

ECHO.
ECHO Player Debug mode has been set
ECHO.
